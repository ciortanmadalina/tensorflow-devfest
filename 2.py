...
W = tf.Variable(tf.zeros([784, NbNodeStep1]))
W1 = tf.Variable(tf.truncated_normal([NbNodeStep1,NbNodeStep2], stddev = 0.1))
W2 = tf.Variable(tf.truncated_normal([NbNodeStep2,NbNodeStep3], stddev = 0.1))
W3 = tf.Variable(tf.truncated_normal([NbNodeStep3,NbNodeStep4], stddev = 0.1))
W4 = tf.Variable(tf.truncated_normal([NbNodeStep4,10], stddev = 0.1))


# biases b[10]
b = tf.Variable(tf.ones([NbNodeStep1])/10)
b1= tf.Variable(tf.ones([NbNodeStep2])/10)
b2= tf.Variable(tf.ones([NbNodeStep3])/10)
b3= tf.Variable(tf.ones([NbNodeStep4])/10)
...
YbeforeDrop = tf.nn.relu(tf.matmul(XX, W) + b)
Y1 = tf.nn.dropout(YbeforeDrop, pkeep)
